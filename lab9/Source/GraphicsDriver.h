...
public:
	...
	RenderTargetPtr GetOffscreenRenderTarget1() {
		return mOffscreenRenderTarget1;
	}

	RenderTargetPtr GetOffscreenRenderTarget2() {
		return mOffscreenRenderTarget2;
	}

	RenderTargetPtr GetHalfRenderTarget() {
		return mHalfRenderTarget;
	}

	RenderTargetPtr GetQuarterRenderTarget1() {
		return mQuarterRenderTarget1;
	}

	RenderTargetPtr GetQuarterRenderTarget2() {
		return mQuarterRenderTarget2;
	}
	...
	ID3D11Texture2D* CreateOffscreenTexture(GraphicsTexturePtr &outTexture, int inWidth, int inHeight);
	RenderTargetPtr CreateOffscreenRenderTarget(ID3D11Texture2D* inTexture);
	...
	BlendStatePtr CreateAdditiveBlendState();
	...
	void SetOffscreenRenderTarget1(RenderTargetPtr inTarget);
	void SetOffscreenRenderTarget2(RenderTargetPtr inTarget);
	void SetHalfRenderTarget(RenderTargetPtr inTarget);
	void SetQuarterRenderTarget1(RenderTargetPtr inTarget);
	void SetQuarterRenderTarget2(RenderTargetPtr inTarget);
...
private:
	...
	RenderTargetPtr mOffscreenRenderTarget1;
	RenderTargetPtr mOffscreenRenderTarget2;
	RenderTargetPtr mHalfRenderTarget;
	RenderTargetPtr mQuarterRenderTarget1;
	RenderTargetPtr mQuarterRenderTarget2;
