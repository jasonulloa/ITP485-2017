...
public:
	...
	void DrawMesh(VertexArrayPtr vertArray, const std::vector<TexturePtr>& texture, const Matrix4& worldTransform, const Vector3& color, EMeshShader type /*= EMS_Basic*/);
