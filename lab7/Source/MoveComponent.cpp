...
void MoveComponent::SetProperties(const rapidjson::Value& properties)
{
	...
	// TODO Lab 3m
	GetFloatFromJSON(properties, "linearSpeed", mLinearSpeed);
	GetFloatFromJSON(properties, "horizontalSpeed", mHorizontalSpeed);
	GetFloatFromJSON(properties, "yawSpeed", mYawSpeed);
	GetFloatFromJSON(properties, "pitchSpeed", mPitchSpeed);
